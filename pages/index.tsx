      ...
      <Tabs.Panel value = "Home" pt = "xs">
        ...
        <div className={styles.container}>
          <Head>
            ...
            <meta name="description" content="Water managmanet and identification" />
          ...
          <main className={styles.main}>
            ...
            <div className={styles.grid}>
              <a href="https://nextjs.org/docs" className={styles.card}>
                ...
                <p>Utilizamos un modelo de inteligancia artificial el cual es capaz de predecir la calidad del agua a partir de diferentes 
                  variables
                </p>
              </a>
              ...
              <a href="https://nextjs.org/learn" className={styles.card}>
                <h2>Sensores &rarr;</h2>
                <p>Descubran los sensores utilizados, los cuales miden las particulas por millon y el flujo del agua, para que este proyecto fuese posible</p>
              </a>
